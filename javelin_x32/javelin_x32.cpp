#include "pch.h"
#include "javelin_x32.h"

#include "javelin_javelin.h"
...
class Discovery
{
    ...
    // https://learn.microsoft.com/en-us/uwp/api/windows.devices.enumeration.devicewatcher?view=winrt-22621
...
public:
    ...
    void start_discovery(JNIEnv* ap_jenv)
    {
        ...
        // Added in isConnectable to ensure that only connectable devices appear
        hstring aqsAllBluetoothLEDevices = L"(System.Devices.Aep.ProtocolId:=\"{bb7bb05e-5972-42b5-94fc-76eaa7084d49}\") AND System.Devices.Aep.Bluetooth.Le.IsConnectable:=System.StructuredQueryType.Boolean#True";
        m_deviceWatcher =
    ...
    {
        // Will return true immediately, can call the the listBLEDevices() function multiple times and it will update names as enumeration goes in the background
        return true;

        // Original code waited for enumeration complete signal
        /*
    ...
    // LM ADDED - stop_discovery function
    void stop_discovery() {
        m_deviceWatcher.Stop();
    }
    ...
    IAsyncOperation<bool> GetBLEDeviceUWP(Windows::Devices::Bluetooth::BluetoothLEDevice& ar_bled, const hstring& ar_id)
    {
...
{
    Discovery* lp_dc = Discovery::getDiscovery();
    // LM ADDED - stop_discovery after listBLEServiceCharacteristics is called
    lp_dc->stop_discovery();
